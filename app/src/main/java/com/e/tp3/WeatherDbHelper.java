...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public Cursor fetchAllCities() {
        ...
        Cursor cursor = db.query(TABLE_NAME,new String[]{_ID,COLUMN_CITY_NAME,COLUMN_COUNTRY,COLUMN_TEMPERATURE,COLUMN_HUMIDITY,COLUMN_WIND_SPEED,COLUMN_WIND_DIRECTION,COLUMN_CLOUDINESS,COLUMN_ICON,COLUMN_DESCRIPTION,COLUMN_LAST_UPDATE},
